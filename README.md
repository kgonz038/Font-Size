...
This application demonstrates the use of menu bars, adding menu items to the menu bar, and writing event handlers for the menu items. Lastly, the event handlers applies an CSS style to change and apply the change in font sizes.

<img src="java font size project.gif">

## [Java file](https://github.com/kgonz038/Font-Size/blob/main/FontSizeSelector_kimberly_gonzalez.java)
